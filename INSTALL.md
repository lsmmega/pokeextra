...
If you have different projects that require different versions of `rgbds`, it might not be convenient to install rgbds 0.8.0 globally. Instead, you can put its files in a directory within pokecrystal, such as `pokecrystal/rgbds-0.7.0/`. Then specify it when you run `make`:
